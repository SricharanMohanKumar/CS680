...
public class ReverseAlphabeticalComparatorTest
{
    ...
    public void Test_getSubDirectories() {
        ...
        List<Directory> element = directory.getSubDirectories(new ReverseAlphabeticalComparator());
        assertArrayEquals(expected,element.toArray() );
    }
    ...
    public void Test_getFiles() {
        ...
        List<File> element = directory.getFiles(new ReverseAlphabeticalComparator());
        assertArrayEquals(expected,element.toArray());
    }
}
