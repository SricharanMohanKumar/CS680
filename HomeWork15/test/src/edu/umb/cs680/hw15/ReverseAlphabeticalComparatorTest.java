...
public class ReverseAlphabeticalComparatorTest
{
    ...
    public void Test_getChildren() {
        ...
        List<FSElement> element = directory.getChildren((FSElement obj1, FSElement obj2) -> obj2.getName().compareTo(obj1.getName()));
    ...
    public void Test_getSubDirectories() {
        ...
        List<Directory> element = directory.getSubDirectories((FSElement obj1, FSElement obj2) -> obj2.getName().compareTo(obj1.getName()));
        assertArrayEquals(expected,element.toArray() );
    }
    ...
    public void Test_getFiles() {
        ...
        List<File> element = directory.getFiles((FSElement obj1, FSElement obj2) -> obj2.getName().compareTo(obj1.getName()));
        assertArrayEquals(expected,element.toArray());
    }
}
