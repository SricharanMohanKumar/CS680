...
public abstract class FSElement
{
    ...
    public static void main(String[] args)
    {
        ...
        String[] dirInfo = {code.getName(), Integer.toString(code.getSize()), optionalDirectory.isPresent()?code.getParent().getName():null,Integer.toString(root.getTotalSize())};
        String[] ar ={"Directory name","Directory size","Parent of the Directory","total Size"};
        for(int i=0;i<4;i++)
        {
